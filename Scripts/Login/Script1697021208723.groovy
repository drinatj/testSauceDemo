...
WebUI.verifyElementPresent(findTestObject('Login/logo_SwagLabs'), 0)

WebUI.verifyElementPresent(findTestObject('Login/input_username'), 0)
...
WebUI.verifyElementPresent(findTestObject('Product List/header_Swaglabs'), 0)
